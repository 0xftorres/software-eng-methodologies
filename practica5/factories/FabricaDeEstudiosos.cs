...
public class FabricaDeEstudiosos: FabricaDeComparables
{
    public FabricaDeEstudiosos() {}
    ...
    public override IComparable crearAleatorio()
    {
        ...
        return new AlumnoProxy(nombre_alumno.getValor(), dni_alumno.getValor(), legajo_alumno.getValor(), promedio_alumno.getValor(), true);
    }
    ...
    public override IComparable crearPorTeclado()
    {
        ...
        return new AlumnoProxy(nombre_alumno, dni_alumno, legajo_alumno, promedio_alumno, true);
    }
}